"""
Test script to check gym owner and reset password if needed
"""
import pymysql
from app.config import Config
import bcrypt

def reset_gym_owner_password():
    """Reset password for a gym owner with QR code"""
    try:
        # Parse database URL
...
if __name__ == "__main__":
    print("=" * 60)
    print("Reset Gym Owner Password")
    print("=" * 60)
    
    email, gym_id = reset_gym_owner_password()
