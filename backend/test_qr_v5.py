"""
Test script to fully activate gym and subscription
"""
import pymysql
from app.config import Config
import bcrypt

def fully_activate_gym():
    """Fully activate gym, subscription, and reset password"""
    try:
        # Parse database URL
...
if __name__ == "__main__":
    print("=" * 60)
    print("Fully Activate Gym and Subscription")
    print("=" * 60)
    
    email, gym_id = fully_activate_gym()
