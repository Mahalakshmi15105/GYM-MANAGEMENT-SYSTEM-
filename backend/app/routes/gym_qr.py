...
def get_qr_image():
    ...
    try:
        ...
        return send_file(img_io, mimetype='image/png', as_attachment=False, download_name=f'gym-{gym.id}-qr.png')
...
def get_printable_qr():
    ...
    try:
        ...
        # Add footer
        footer = f"Generated by FlexiGym - Gym ID: {gym.id}"
